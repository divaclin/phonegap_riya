var camera = {
  ...
  takePicture: function(){
    CameraPreview.takePicture({width:window.screen.width*2,height:window.screen.height*2,quality:100},function(imgData){
      ...
      space[spaceIndex][spaceIndexIndex]['real'] = getDistance(glAllData.height,glAllData.phoneHeight,space[spaceIndex][spaceIndexIndex]['a'],space[spaceIndex][spaceIndexIndex]['b'],glAllData.mode);
